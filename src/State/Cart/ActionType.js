...
export const MERGE_GUEST_CART_REQUEST = "MERGE_GUEST_CART_REQUEST";
export const MERGE_GUEST_CART_SUCCESS = "MERGE_GUEST_CART_SUCCESS";
export const MERGE_GUEST_CART_FAILURE = "MERGE_GUEST_CART_FAILURE";
